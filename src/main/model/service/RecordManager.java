...
public class RecordManager {
	...
	public int insertRecord(String title, String creationDate, int totalTime, int category,
		...
		return recordDao.insertRecord(title, creationDate, totalTime, category, routine, diet, photo, shareOption, exerciserId);
	}
	...
	public int updateRecord(int recordId, String title, String creationDate, int totalTime, int category,
			String routine, String diet, String photo, int shareOption, int exerciserId) {
		return updateRecord(recordId, title, creationDate, totalTime, category, routine, diet, photo, shareOption, exerciserId);
	}
