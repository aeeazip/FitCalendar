	...
	<table width="800">
		...
		<tr>
			<td width="300" align="center" bgcolor="E6ECDE" height="40">운동
				종류</td>
			<td width="500" bgcolor="ffffff" style="padding-left: 10">&nbsp;&nbsp;&nbsp;&nbsp;헬스</td>
		</tr>
		<tr>
			<td width="300" align="center" bgcolor="E6ECDE" height="40">총 운동시간</td>
			<td width="500" bgcolor="ffffff" style="padding-left: 10">&nbsp;&nbsp;&nbsp;&nbsp;${record.totalTime}</td>
		</tr>
		<tr>
			<td width="300" align="center" bgcolor="E6ECDE" height="40">운동 루틴</td>
			<td width="500" bgcolor="ffffff" style="padding-left: 10">&nbsp;&nbsp;&nbsp;&nbsp;${record.routine}</td>
		</tr>
		<tr>
			<td width="300" align="center" bgcolor="E6ECDE" height="40">운동 식단</td>
		...
		<tr>
			<td width="300" align="center" bgcolor="E6ECDE" height="40">공유 허용</td>
			<td width="500" bgcolor="ffffff" style="padding-left: 10">
				<c:if test="${record.shareOption eq '1'}">
					<p>&nbsp;&nbsp;&nbsp;&nbsp;예</p>
				</c:if> 
				<c:if test="${record.shareOption eq '0'}">
					<p>&nbsp;&nbsp;&nbsp;&nbsp;아니요</p>
				</c:if> 
			</td>
		</tr>
