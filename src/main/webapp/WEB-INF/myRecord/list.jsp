					...
					<c:forEach var="record" items="${recordList}">
						<tr>
							...
							<td bgcolor="ffffff" style="padding-left: 10" class="b">
								<a href="<c:url value='/myRecord/list/detail'><c:param name='recordId' value='${record.recordId}'/></c:url>">${record.title}</a>
							</td>
							...
							<td bgcolor="ffffff" style="padding-left: 10" align="center" class="b">${nickname}</td>
						</tr>
