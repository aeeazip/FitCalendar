...
public class MatchingWantRecommendController_serve implements Controller{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		...
		case 1: percentBodyFat1 = 0;
			percentBodyFat2 = 14;
			break;

		case 2: percentBodyFat1 = 15;
			percentBodyFat2 = 24;
			break;
		case 3:percentBodyFat1 = 25;
			percentBodyFat2 = 34;
			break;
		case 4: percentBodyFat1 = 35;
			percentBodyFat2 = 50;
			break;

		}
		System.out.println(height1);
		int result = recommendManager.recommendExerciser(exerciser.getExerciserId(), height1, height2, weight1, weight2, percentBodyFat1, percentBodyFat2);
